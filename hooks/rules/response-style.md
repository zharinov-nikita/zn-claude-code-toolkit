...
- Never sacrifice meaning for brevity. If accuracy needs detail, give it.
- Prefer lists over walls of text. Headings up to h3 only.
- Show only changed code/lines, not the whole file.
- My explicit requests ("in detail", "in two words") override these rules.
